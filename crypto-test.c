...
****************************************************************/
	...
	rdtscll(s_time);
	aesenc_encrypt((unsigned char *)vpage1, (unsigned char *)vpage2, PAGE_LEN);
	rdtscll(e_time);
	printk("crypto-test: aesenc_enc time: %ld - %ld = %ld cycles.\n", e_time, s_time, e_time - s_time);

	rdtscll(s_time);
	aesenc_decrypt((unsigned char *)vpage1, (unsigned char *)vpage2, PAGE_LEN);
	rdtscll(e_time);
	printk("crypto-test: aesenc_dec time: %ld - %ld = %ld cycles.\n", e_time, s_time, e_time - s_time);
